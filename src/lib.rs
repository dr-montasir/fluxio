...
//! # fluxio
//!
//! fluxio is a **fast** and **correct** HTTP implementation written in and for Rust.
//!
//! ## Features
//!
//! - HTTP/1 and HTTP/2
...
//! ## "Low-level"
//!
//! fluxio is a lower-level HTTP library, meant to be a building block
...
//! # Optional Features
//!
//! fluxio uses a set of [feature flags] to reduce the amount of compiled code.
//! It is possible to just enable certain features over others. By default,
//! fluxio does not enable any features but allows one to enable a subset for
//! their use case. Below is a list of the available feature flags. You may
//! also notice above each function, struct and trait there is listed one or
//! more feature flags that are required for that item to be used.
//!
//! If you are new to fluxio it is possible to enable the `full` feature flag
