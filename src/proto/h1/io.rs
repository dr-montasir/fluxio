...
mod tests {
    ...
    */
    ...
    fn write_buf_queue() {
        ...
        buffered.buffer(Cursor::new(b"fluxio!".to_vec()));
        assert_eq!(buffered.write_buf.queue.bufs_cnt(), 3);
        buffered.flush().unwrap();

        assert_eq!(buffered.io, b"hello world, it's fluxio!");
    ...
    */
    ...
    async fn write_buf_flatten() {
        ...
        let mock = Mock::new().write(b"hello world, it's fluxio!").build();
    ...
    fn write_buf_flatten_partially_flushed() {
        ...
        write_buf.buffer(b("it's fluxio!"));

        assert_eq!(write_buf.chunk(), b", it's fluxio!");
        assert_eq!(write_buf.headers.pos, 11);
