...
/// # async fn doc() -> fluxio::Result<()> {
/// use fluxio::{body::HttpBody};
///
/// # let request = fluxio::Request::builder()
/// #        .method(fluxio::Method::POST)
/// #        .uri("http://httpbin.org/post")
/// #        .header("content-type", "application/json")
/// #        .body(fluxio::Body::from(r#"{"library":"fluxio"}"#)).unwrap();
/// # let client = fluxio::Client::new();
...
///     let body_bytes = fluxio::body::to_bytes(response.into_body()).await?;
