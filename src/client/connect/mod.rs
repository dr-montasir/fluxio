...
//! use fluxio::{service::Service, Uri};
...
//! # #[cfg(feature = "runtime")]
//! # fn rt () {
//! # let connector = fluxio::client::HttpConnector::new();
//! // let connector = ...
//!
//! let client = fluxio::Client::builder()
//!     .build::<_, fluxio::Body>(connector);
//! # }
//! ```
//!
//!
...
pub(super) mod sealed {
    ...
    /// additional bounds set for convenience *inside* fluxio. You don't actually
