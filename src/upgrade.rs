//! HTTP Upgrades
//!
//! This module deals with managing [HTTP Upgrades][mdn] in fluxio. Since
...
//! corresponding headers in a response. To then wait for fluxio to finish the
...
//! Clients and Servers.
//!
//! [example]: https://github.com/dr-montasir/fluxio/blob/master/examples/upgrades.rs
